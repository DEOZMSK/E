...
export const metadata: Metadata = {
  title: "Пользовательское соглашение EFITNES",
  description:
    "Условия использования сайта EFITNES, Telegram-бота и согласие на обработку персональных данных от самозанятого консультанта Елены.",
  alternates: {
  ...
  openGraph: {
    title: "Пользовательское соглашение EFITNES",
    description:
      "Документ описывает правила EFITNES и работу с персональными данными. Елена Ксорос, фитнес-тренер.",
    url: "/user-agreement"
  },
  twitter: {
  ...
  return (
    <>
      ...
      <section className="space-y-3 rounded-3xl border border-outline/60 bg-white/80 p-6 shadow-lg">
        ...
        <p>
          1.2. Оператором сервиса является самозанятый Артемий Ксорос (ИНН 500119421000), отвечающий за сайт и IT-инфраструктуру EFITNES. Сервис предоставляет информационные и фитнес-образовательные материалы.
        </p>
        <p>
      ...
      <section className="space-y-3 rounded-3xl border border-outline/60 bg-white/80 p-6 shadow-lg">
        ...
        <p>
          4.2. Обрабатываемые данные включают имя/псевдоним, контактные сведения, Telegram username, добровольно предоставленные Пользователем данные для фитнес-диагностики (рост, вес, возраст, уровень активности, обхваты/замеры, питание, ограничения и противопоказания), содержимое запросов, файлы, платежную информацию (в пределах, необходимых для подтверждения оплаты), а также данные, автоматически собираемые с помощью cookie и аналитических сервисов.
        </p>
        <p>
      ...
      <section className="space-y-3 rounded-3xl border border-outline/60 bg-white/80 p-6 shadow-lg">
        ...
        <p>
          7.2. Пользователь самостоятельно принимает решения, основанные на рекомендациях EFITNES. Оператор не гарантирует получение конкретного результата и не отвечает за упущенную выгоду.
        </p>
        <p>
