...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Пользовательское соглашение EFITNES",
    description:
      "Документ определяет правила пользования сервисом EFITNES, ответственность сторон и порядок обработки персональных данных.",
    url: "/user-agreement"
  },
  twitter: {
    ...
    <>
      ...
      <header className="space-y-3 text-neutral-900">
        ...
        <p className="text-sm text-neutral-500">
          Оферта самозанятого консультанта Елены (ИНН {requisites.inn}), действующего в статусе плательщика налога на профессиональный доход, расположенного в Москве, Россия.
        </p>
        <p className="text-sm text-neutral-600">
          ...
          @EFITNES_BOT и прямых контактов с Еленой в Telegram @Al0PBEDA.
        </p>
      </header>
      ...
      <section className="space-y-3 rounded-3xl border border-outline/60 bg-white/80 p-6 shadow-lg">
        ...
        <p>
          1.2. Оператором сервиса является самозанятый Елена. Сервис предоставляет консультационные услуги с использованием авторской системы искусственного интеллекта EFITNES.
        </p>
        <p>
