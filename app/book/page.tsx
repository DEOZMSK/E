...
export const metadata: Metadata = {
  ...
  description:
    "Выберите фитнес-диагностику или персональное сопровождение, дату и удобное время. Запись подтверждается сразу после бронирования.",
  alternates: {
    canonical: "/book"
  },
  openGraph: {
    title: "Запись к Елене Ксорос",
    description: "Онлайн-запись к Елене Ксорос: фитнес-диагностика за 1500 RUB и персональное сопровождение за 12000 RUB.",
    url: "/book",
    images: [
      {
        url: "/photo.png",
