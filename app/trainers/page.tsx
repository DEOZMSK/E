...
export const metadata: Metadata = {
  ...
  description:
    "Профессиональные фитнес-расчёты для оценки клиента: антропометрия, состав тела, силовые тесты, гибкость и тренировочные ориентиры.",
  alternates: {
    canonical: "/trainers"
  }
};
      ...
      <div className="mx-auto max-w-6xl space-y-6">
        <header className="space-y-2">
          ...
          <p className="text-base text-neutral-300 sm:text-lg">
            Профессиональные фитнес-расчёты для оценки клиента: антропометрия, состав тела, силовые
            тесты, гибкость и тренировочные ориентиры.
          </p>
        </header>
